...
$class_menu = \UNISUS_THEME\Inc\Menus::getInstance();
$header_menu_id = $class_menu->get_menu_id('unisus-header-menu');
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <?php
        //header menu should not be empty and it should be an array
