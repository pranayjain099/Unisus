...
class Assets
{
    ...
    {
        //Register styles
        wp_register_style('style-css', get_stylesheet_uri(), [], filemtime(UNISUS_DIR_URI . '/style.css'), 'all');
    ...
    {
        // Registering scripts 
        wp_register_script('main-js', UNISUS_DIR_URI . '/assets/main.js', [], filemtime(UNISUS_DIR_URI . '/assets/main.js'), true);
